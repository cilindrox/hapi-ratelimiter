...
const internals = {
    defaults: {
        ...
        redis: null,
        whiteListIpRange: ["64.18.0.0/20","64.233.160.0/19","66.102.0.0/20","66.249.80.0/20","66.249.64.0/19", "72.14.192.0/18",
...
exports.register = (server, options, next) => {
    ...
    server.ext('onPreAuth', (request, reply) => {
        ...
        if (routeLimit) {
            ...
            if (ipRangeCheck(ip,settings.whiteListIpRange)) {
            ...
            if (ipRangeCheck(ipts,settings.whiteListIpRange)) {
                return reply.continue();
            }
            console.log('not white listed ' + ip);
